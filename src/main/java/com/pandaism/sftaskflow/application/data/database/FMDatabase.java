...
public class FMDatabase extends Database {
    public FMDatabase() {
        super("WASTE");
    }
                ...
                if((connection = getConnection()) != null) {
                    try {
                        String query = "SELECT \n" +
                                ...
                                "WHERE\n" +
                                "\t(JCFKL.ISSUED_QTY != 0) AND (JCFJM.JOB_STATUS = 'O') AND (JCFJM.STORES_CODE IN ('6H'));";
