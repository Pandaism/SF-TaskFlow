...
public class SeonDatabase extends Database {
    public SeonDatabase() {
        super("PT");
    }
                ...
                if((connection = getConnection()) != null) {
                    try {
                        ...
                        String query = "WITH Modifications AS (\n" +
                                ...
                                "\tAND JCFJM.STORES_CODE IN ('3M', '3T', '3P')\n" +
                                "\tAND JCFJM.JOB_ID != 102966" +
                        ...
                        try (ResultSet rs = ps.executeQuery()) {
                            while (rs.next()) {
                                ...
                                if(SFTaskFlowApplication.itProdFilterList.getFilterList().contains(partID.trim())) {
                                    workOrder.setType("IT PROD");
                                }
                ...
                if((connection = getConnection()) != null) {
                    try {
                        String query = "SELECT \n" +
                                ...
                                "WHERE\n" +
                                "\t(JCFKL.ISSUED_QTY != 0) AND (JCFJM.JOB_STATUS = 'O') AND (JCFJM.STORES_CODE IN ('3M', '3T', '3P'));";
